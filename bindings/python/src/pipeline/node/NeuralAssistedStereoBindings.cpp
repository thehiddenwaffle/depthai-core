...
void bind_neuralassistedstereo(pybind11::module& m, void* pCallstack) {
    ...
    node.def_property_readonly(
        ...
        .def_property_readonly(
            "depth", [](NeuralAssistedStereo& self) -> Node::Output& { return self.depth; }, DOC(dai, node, NeuralAssistedStereo, depth))
        .def_property_readonly(
            "disparity", [](NeuralAssistedStereo& self) -> Node::Output& { return self.disparity; }, DOC(dai, node, NeuralAssistedStereo, disparity))
        .def("build",
             &NeuralAssistedStereo::build,
             py::arg("leftInput"),
             py::arg("rightInput"),
             py::arg("neuralModel") = DeviceModelZoo::NEURAL_384X240,
