...
const dai::Color FONT_BACKGROUND_COLOR = dai::Color(0.0, 0.0, 0.0, 0.7);
const dai::Color KEYPOINT_COLOR = dai::Color(0.0, 1.0, 1.0, 1.0);
constexpr float_t KEYPOINT_THICKNESS_PER_RESOLUTION = 1.0 / 100;
...
[[maybe_unused]] static float_t keypointThickness(const float_t& width, const float_t& height) {
    return KEYPOINT_THICKNESS_PER_RESOLUTION * (width + height) / 2;
}
